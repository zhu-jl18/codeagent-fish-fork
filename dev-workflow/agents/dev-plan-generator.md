...
- code-dispatcher analysis results (feature highlights, task decomposition, UI detection flag, and task typing hints)
...
1. **Analyze Input**: Review the requirements description and code-dispatcher analysis results (including `needs_ui` and any task typing hints)
